...
import slides from "./RecoveryInfo.slides";
...
import Slider4 from "../../../assets/images/Onboarding/Slider4";

const ViewRecoveryInfo: React.FunctionComponent<IStackScreenProps> = (props) => {
  ...
  const continueHandler = () => {
    navigation.navigate("RecoveryEnterPin");
  }
  ...
  return (
    <ScreenComponent>
      ...
      <View style={{alignSelf:"center", justifyContent:"center", marginTop:hp("10%")}}>
            <Slider4/>
      </View>
        <FlatList
          data={slides}
...
export default ViewRecoveryInfo;