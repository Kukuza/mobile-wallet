...
export class WakalaContractEventsKit {
     ...
     */
    public wakalaEscrowContract?: Contract;

    /**
     * Instance of websocket provider.
     */
    public provider = new Web3.providers.WebsocketProvider('wss://alfajores-forno.celo-testnet.org/ws');
    ...
    setupProviderAndSubscriptions() {
        ...
        this.provider = new Web3.providers.WebsocketProvider('wss://alfajores-forno.celo-testnet.org/ws');
